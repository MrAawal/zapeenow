...
export const createOrder = async (req, reply) => {
  try {
    ...
    const { items, totalPrice,deliveryCharge,handlingCharge,surgeCharge } = req.body

    const customerData = await Customer.findById(userId)
    const branch = customerData.branch;
    ...
    const newOrder = new Order({
      ...
      branch,
      totalPrice,deliveryCharge,handlingCharge,surgeCharge,
      deliveryLocation: {
